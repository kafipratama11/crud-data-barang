...
$result = mysqli_query($mysqli, "SELECT * FROM tb_penjualan ");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="col">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb ps-3 fs-6">
              ...
              <li class="breadcrumb-item">
                <a class="text-decoration-none" href="data_detail_jual.php">Data Detail Penjualan</a>
              </li>
            </ol>
          </nav>
        </div>
      ...
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
            <div class="col">
              <label class="fw-bold mb-3">Data Penjualan</label>
            </div>
            <div class="add col">
              <button
                type="button"
    ...
    while($user_data = mysqli_fetch_array($result)) {         
        ...
        echo "<td>".$user_data['tanggal_jual']."</td>";    
